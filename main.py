...
if __name__ == "__main__":
    ...
    print(f'CDF   P(x<20) = {norm_dist.cdf(20, True)}')
    ...
    print(f'CDF   P(x>0) = {std_norm_dist.cdfr(0, True)}')
    ...
    print(f'CDF   P(x<2.645) = {std_norm_dist.cdfr(2.645)}')
    print(f'CDF   P(x>2.645) = {std_norm_dist.cdfr(2.645)}')
    print(f'CDF   P(0<x<1.96) = {std_norm_dist.cdfb(0, 1.96, True)}')
    ...
    print(f'CDF   x where P(X<x) = 0.9500,   x = {std_norm_dist.inv(0.950)}')
    print(f'CDF   x where P(X<x) = 0.0500,   x = {std_norm_dist.inv(0.050)}')
    print(f'CDF   x where P(X>x) = 0.9500,   x = {std_norm_dist.invr(0.950)}')
    print(f'CDF   x where P(X>x) = 0.0500,   x = {std_norm_dist.invr(0.050)}')
    print(f'CDF   x where P(-x<X<x) = 0.50,   x = {std_norm_dist.invm(0.50)}')
