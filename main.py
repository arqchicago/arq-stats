...
if __name__ == "__main__":
    ...
    print(f'CDF   P(x<20) = {norm_dist.cdf(20, True, "x20")}')
    print(f'CDF   P(x<23.92) = {norm_dist.cdf(23.92)}')
    print(f'CDF   P(x>20) = {norm_dist.cdfr(20, True)}')
    print(f'CDF   P(x>23.92) = {norm_dist.cdfr(23.92)}')
    print(f'CDF   P(20<x<23.92) = {norm_dist.cdfb(20, 23.92, True)}')
    ...
    print(f'CDF   x where P(X<x) = 0.9500,   x = {norm_dist.inv(0.950)}')
    print(f'CDF   x where P(X<x) = 0.0500,   x = {norm_dist.inv(0.050)}')
    print(f'CDF   x where P(X>x) = 0.9500,   x = {norm_dist.invr(0.950)}')
    print(f'CDF   x where P(X>x) = 0.0500,   x = {norm_dist.invr(0.050)}')
    print(f'CDF   x where P(-x<X<x) = 0.50,   x = {norm_dist.invm(0.50)}')
    ...
    print(f'PDF   P(z=0) = {std_norm_dist.pdf(0)}')
    print(f'PDF   P(z=1.96) = {std_norm_dist.pdf(1.96)}')
    print(f'CDF   P(z<0) = {std_norm_dist.cdf(0, True, "z0")}')
    print(f'CDF   P(z>0) = {std_norm_dist.cdfr(0, True)}')
    print(f'CDF   P(z<1.645) = {std_norm_dist.cdf(1.645)}')
    print(f'CDF   P(z>1.645) = {std_norm_dist.cdfr(1.645)}')
    print(f'CDF   P(z<1.96) = {std_norm_dist.cdf(1.96)}')
    print(f'CDF   P(z>1.96) = {std_norm_dist.cdfr(1.96)}')
    print(f'CDF   P(z<2.645) = {std_norm_dist.cdfr(2.645)}')
    print(f'CDF   P(z>2.645) = {std_norm_dist.cdfr(2.645)}')
    print(f'CDF   P(0<z<1.96) = {std_norm_dist.cdfb(0, 1.96, True)}')
    print(f'CDF   P(-1.96<z<1.96) = {std_norm_dist.cdfb(-1.96, 1.96)}')
    print(f'CDF   z where P(Z<z) = 0.9750,   z = {std_norm_dist.inv(0.975)}')
    print(f'CDF   z where P(Z<z) = 0.0250,   z = {std_norm_dist.inv(0.025)}')
    print(f'CDF   z where P(Z>z) = 0.9750,   z = {std_norm_dist.invr(0.975)}')
    print(f'CDF   z where P(Z>z) = 0.0250,   z = {std_norm_dist.invr(0.025)}')
    print(f'CDF   z where P(Z<z) = 0.9500,   z = {std_norm_dist.inv(0.950)}')
    print(f'CDF   z where P(Z<z) = 0.0500,   z = {std_norm_dist.inv(0.050)}')
    print(f'CDF   z where P(Z>z) = 0.9500,   z = {std_norm_dist.invr(0.950)}')
    print(f'CDF   z where P(Z>z) = 0.0500,   z = {std_norm_dist.invr(0.050)}')
    print(f'CDF   z where P(-z<Z<z) = 0.50,   z = {std_norm_dist.invm(0.50)}')
    print(f'CDF   z where P(-z<Z<z) = 0.90,   z = {std_norm_dist.invm(0.90)}')
    print(f'CDF   z where P(-z<Z<z) = 0.95,   z = {std_norm_dist.invm(0.95)}')
    print(f'CDF   z where P(-z<Z<z) = 0.99,   z = {std_norm_dist.invm(0.99)}')
